...
namespace DTO
{
    public class ThamSoDTO
    {
        ...
        public ThamSoDTO(float thoiGianBayToiThieu, int soSanBayTGToiDa, float thoiGianDungToiThieu, float thoiGianDungToiDa, float thoiGianChamNhatDatVe, float thoiGianChamNhatHuyVe)
        {
